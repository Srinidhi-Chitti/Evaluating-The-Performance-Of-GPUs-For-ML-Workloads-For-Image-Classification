...
from src.input_pipeline.inputcnn import train_ds_cifar10, test_ds_cifar10
...
train_ds = train_ds_cifar10
test_ds = test_ds_cifar10
...
with open("cnn_cifar10_params.pkl", "wb") as f:
    pickle.dump(state.params, f)

print("CIFAR10 model parameters saved!")